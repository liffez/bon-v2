# CLAUDE_INDKOB_6F.md
> Spec for Fase 6f — Indkøb: samlet liste, opret/kobl-flow og kanal-labels
> Læs `CLAUDE_INDKOB.md`, `CLAUDE_SETTINGS_INDKOB.md` OG **`shared/indkob.js`** FØR du begynder.
> Mockup: `docs/indkob_mockup_6f.html`
...
```
#### Fase 6f — Indkøb: samlet liste + opret/kobl (spec: CLAUDE_INDKOB_6F.md)
